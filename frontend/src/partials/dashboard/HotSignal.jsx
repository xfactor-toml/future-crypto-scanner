...
function HotSignal(hot) {
  ...
  return (
    <div className="animate-fade duration-1500 mt-[20px] w-[98%] min-h-[250px] mx-auto col-span-full rounded-xl xl:col-span-full bg-white dark:bg-gray-900 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
