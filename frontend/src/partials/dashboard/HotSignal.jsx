...
import Icon from '../../images/unKnown.png';
                ...
                if(index < 5)
                  return (<ul className="grid grid-cols-7 gap-x-3">
                    ...
                    <li key={item} className="text-center font-semibold">
                      {
                        (item._3minchange > 0)?<span className='text-emerald-500'>long</span>:<span className='text-red-500'>short</span>  
                      }
                    </li>
                  </ul>)
              }
      ...
      {/* <div className="px-3 flex justify-end">
        <ul className="pagination flex justify-between">
          <button
            ...
            className="pagination-button ml-3"
          >
